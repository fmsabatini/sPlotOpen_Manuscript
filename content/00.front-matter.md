...
{% for author in manubot.authors %}
  ...
  {%- endif %}{{author.name}}<sup>{% for number in author.affiliation_numbers %}{{number}}{%- if not loop.last -%},{%- endif -%}{% endfor %}{%- if author.symbol_str is defined -%},{{author.symbol_str}}{%- endif -%}</sup>
