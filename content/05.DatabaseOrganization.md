...
Except 'reference' file (format .bib), all objects are provided in tab-delimited .txt files. All objects, including the 'sPlotOpen_citation' function, are also compiled inside an .RData object.
