...
We also removed vegetation plots identified by the respective data contributors as having been recorded from wetlands and from anthropogenic vegetation types, since these data were available only for few geographic regions, mostly in Europe. 
