...
The resampling procedure resulted in xx,xxx, xx,xxx and xx,xxx vegetation plots selected during resampling iteration #1, #2 and #3, respectively, leading to a preliminary selection of 107,238 unique vegetation plots when pooling vegetation plots from all three resampling iterations.
...
Of these, 6,625 were first choice plots selected by the resampling iteration #1, and were distributed across 770 PC1-PC2 grid cells (44.1% of occupied cells). 
