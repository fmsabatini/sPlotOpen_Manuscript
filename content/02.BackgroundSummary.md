...
Compared to species-level occurence data, vegetation plot data present many advantages for plant biodiversity research. 
...
Given the importance of vegetation-based global studies and the need to fill in the existing data availability gap, the sPlot initiative tries to close this data gap. 
...
Here, we provide an open-access data set composed of 91,031 vegetation plots, representative of the main dimensions of the environmental space covered by the sPlot database. 
