...
As they normally contain also information on the relative cover or abundance of each species, vegetation plots are much adequate to detect subtle biodiversity changes, compared to data based on the occurrence of individual species only (@doi:10.1111/j.1654-1103.2011.01318.x).  

Vegetation-plot data are very fragmented, though, as they typically stem from a myriad of research projects (a reference?). 
