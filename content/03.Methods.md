...
To reduce this imbalance to the extent possible, we performed a stratified resampling approach, using several environmental variables available to the global extent as sampling strata. 
...
In this way, we reduced the imbalance towards over-sampled climate types while ensuring the resampled dataset represents the entire environmental gradient covered by the sPlot database.
