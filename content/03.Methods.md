...
<!-- Comments can be given by html comment notation-->
...
We then subdivided the environmental space represented by the first two principal components (PC1–PC2), accounting for 47% and 23% of the total variation on PC1 and PC2, respectively, into a 100 × 100 grid. <!-- What unit? What kind of subdivision-->
...
Before projecting vegetation plots from the sPlot database v2.1 onto this PC1-PC2 environmental space, we removed vegetation plots: from wetlands; from anthropogenic vegetation types  <!-- Why? How did you select wetland or anthropogenic plots--> ; without geographical coordinates; and with a location uncertainty higher than 3 km for those having geographical coordinates. 
