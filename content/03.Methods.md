...
Mid-latitude regions in developed countries (mostly Europe, the USA and Australia) are overrepresented, while regions in the tropics and subtropics, and inaccessible areas in general, are underrepresented, which is a typical geographical bias in biodiversity data (e.g., @doi:10.1111/ecog.00967; @doi:10.1038/s41559-020-1198-2). 
...
We considered 30 climatic and soil variables, which are key to plant development, and available at the global scale with 1 km resolution. 
