...
<small><em>
This manuscript
([permalink](https://fmsabatini.github.io/sPlotOpen_Manuscript/v/26d744f3d4fb4c6d4b46497f350b279bc418da26/))
was automatically generated
from [fmsabatini/sPlotOpen_Manuscript@26d744f](https://github.com/fmsabatini/sPlotOpen_Manuscript/tree/26d744f3d4fb4c6d4b46497f350b279bc418da26)
on December 9, 2020.
</em></small>
...
152. ILEX Consultoria Científica, Amelia Telles 184, 9.046007E7, Porto Alegre, Brazil<br>
...
![Distribution of all the vegetation plots in sPlotOpen (n = 91,205) in the two-dimensional climatic space represented by mean annual temperature and mean annual precipitation color coded based on biomes as defined by Schultz 2005 (@doi:10.1007/3-540-28527-x) modified to include also the alpine biome from Körner et al. (2017)(@doi:10.1007/s00035-016-0182-6)(left), superimposed onto Whittaker biomes (@Whittaker1975) (right).](images/figure2.png){#fig:Figure2}
...
## Figure S2 {.page_break_before}

![Spatial distribution of principal component analysis (PCA) values. The PCA is based on the matrix of all terrestrial grid cells (n = 8,384,404, spatial grain = 2.5 arcmin) by 30 environmental variables.](images/figureS2.png){#fig:supplement tag="S2"}
